...
private:
	...
	unique_ptr<AudioTransportSource> transportSource = make_unique<AudioTransportSource>();
	unique_ptr<AudioFormatManager> formatManager = make_unique<AudioFormatManager>();
